...
public class MlDialog extends MlBaseDialog implements IDialog {

    private MlDialogController controller;
    ...
    public MlDialog() {
        controller = new MlDialogController(this);
    }
    ...
    public static class Builder {
        private MlDialogController.SYParams params;
        private IDialog.OnBuildListener buildListener;
        private IDialog.OnDismissListener dismissListener;
        ...
        public Builder(Context context) {
            ...
            params = new MlDialogController.SYParams();
        ...
        public Builder setScreenWidthP(float percentage) {
            params.dialogWidth = (int) (ScreenUtils.getWidth((Activity) params.context) * percentage);
            return this;
        }
        ...
        public Builder setScreenHeightP(float percentage) {
            params.dialogHeight = (int) (ScreenUtils.getHeight((Activity) params.context) * percentage);
            return this;
        }
        ...
        private MlDialog create() {
            MlDialog dialog = new MlDialog();
        ...
        private void setDefaultOption() {
            ...
            params.layoutRes = R.layout.base_layout_dialog_new;
            params.dimAmount = 0.5f;
            params.dialogWidth = (int) (ScreenUtils.getWidth((Activity) params.context) * 0.8f);
